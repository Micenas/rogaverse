Contributing to rogaverse Core
============================

The rogaverse Core project operates an open contributor model where anyone is
...
The following applies to code changes to the rogaverse Core project, and is not to be
confused with overall rogaverse Network Protocol consensus changes.

Whether a pull request is merged into rogaverse Core rests with the project merge
...
Patches that change rogaverse consensus rules are considerably more involved than
...
Where a patch set proposes to change the rogaverse consensus, it must have been
...
The project leader is the release manager for each rogaverse Core release.
