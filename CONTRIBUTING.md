Contributing to birjees Core
============================

The birjees Core project operates an open contributor model where anyone is
...
The following applies to code changes to the birjees Core project, and is not to be
confused with overall birjees Network Protocol consensus changes.

Whether a pull request is merged into birjees Core rests with the project merge
...
Patches that change birjees consensus rules are considerably more involved than
...
Where a patch set proposes to change the birjees consensus, it must have been
...
The project leader is the release manager for each birjees Core release.
