...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("rogaverse Core rogaverse-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  rogaverse-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rogaverse transaction") + "\n" +
                               "  rogaverse-tx [options] -create [commands]   " + _("Create hex-encoded rogaverse transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rogaverse transaction
