...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("birjees Core birjees-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  birjees-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded birjees transaction") + "\n" +
                               "  birjees-tx [options] -create [commands]   " + _("Create hex-encoded birjees transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded birjees transaction
