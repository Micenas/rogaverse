                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Birjees Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a birjees address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and birjees: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About birjees Core"), this);
    aboutAction->setStatusTip(tr("Show information about birjees Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for birjees"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your birjees addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified birjees addresses"));
    ...
    openAction->setStatusTip(tr("Open a birjees: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the birjees Core help message to get a list with possible birjees command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("birjees Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to birjees network", "", count));
}
...
{
    QString strTitle = tr("birjees Core"); // default title
