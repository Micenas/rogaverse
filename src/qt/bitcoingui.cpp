                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ROGAVERSE Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a rogaverse address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rogaverse: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About rogaverse Core"), this);
    aboutAction->setStatusTip(tr("Show information about rogaverse Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for rogaverse"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your rogaverse addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified rogaverse addresses"));
    ...
    openAction->setStatusTip(tr("Open a rogaverse: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the rogaverse Core help message to get a list with possible rogaverse command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("rogaverse Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to rogaverse network", "", count));
}
...
{
    QString strTitle = tr("rogaverse Core"); // default title
