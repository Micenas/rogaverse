...
/** Utility functions used by the rogaverse Qt UI.
 */
namespace GUIUtil
{
...
// Render rogaverse addresses in monospace font
...
// Parse "rogaverse:" URI into recipient object, return true on successful parsing
