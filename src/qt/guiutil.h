...
/** Utility functions used by the birjees Qt UI.
 */
namespace GUIUtil
{
...
// Render birjees addresses in monospace font
...
// Parse "birjees:" URI into recipient object, return true on successful parsing
