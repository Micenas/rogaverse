...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("rogaverse Core"),
     ...
     * override -datadir in the rogaverse.conf file in the default data directory
     * (to be consistent with rogaversed behavior)
     */
    if (dataDir != getDefaultDataDirectory())
