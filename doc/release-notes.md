rogaverse Core version 2.3.0 is now available from:

  <https://github.com/rogaverse-project/rogaverse/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/rogaverse-project/rogaverse/issues>

Compatibility
==============

rogaverse Core is extensively tested on multiple operating systems using
...
rogaverse Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) rogaverse MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode rogaverse address
...
rogaverse Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for rogaverse (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with rogaverse (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/rogaverse-project-translations/).
