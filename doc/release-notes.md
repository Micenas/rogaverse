birjees Core version 2.3.0 is now available from:

  <https://github.com/birjees-project/birjees/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/birjees-project/birjees/issues>

Compatibility
==============

birjees Core is extensively tested on multiple operating systems using
...
birjees Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) birjees MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode birjees address
...
birjees Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for birjees (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with birjees (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/birjees-project-translations/).
