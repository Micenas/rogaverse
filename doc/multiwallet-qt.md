...
In order to support loading of multiple wallets in birjees-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is birjees.cpp.
...
Changes to birjees.cpp
----------------------
birjees.cpp is the entry point into birjees-qt, and as such, will require some minor modifications to provide hooks for
