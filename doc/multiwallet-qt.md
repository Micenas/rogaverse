...
In order to support loading of multiple wallets in rogaverse-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is rogaverse.cpp.
...
Changes to rogaverse.cpp
----------------------
rogaverse.cpp is the entry point into rogaverse-qt, and as such, will require some minor modifications to provide hooks for
